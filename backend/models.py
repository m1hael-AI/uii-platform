...
ВАЖНО:
- Если в диалоге НЕТ сообщений от пользователя (только приветствие бота) — верни пустую строку или текущую память без изменений.
- НЕ выдумывай факты, если пользователь молчит.
