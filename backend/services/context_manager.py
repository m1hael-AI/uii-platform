    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            prompt = (
                ...
                f"Твоя задача — сжать этот диалог в одно краткое, но информативное саммари (конспект).\n"
                f"Сохрани все ключевые факты, имена, даты и контекст обсуждения, чтобы AI мог продолжить разговор, понимая о чем шла речь ранее.\n"
                f"Игнорируй приветствия и 'воду'.\n\n"
                f"=== ДИАЛОГ ===\n"
